...
sed -i "s/containerImage:.*/containerImage: quay.io\/projectquay\/quay-operator:${RELEASE}/" bundle/manifests/quay-operator.clusterserviceversion.yaml
sed -i "s/^  name: quay-operator.*/  name: quay-operator.${RELEASE}/" bundle/manifests/quay-operator.clusterserviceversion.yaml
sed -i "s/image: quay.io\/projectquay\/quay-operator.*/image: quay.io\/projectquay\/quay-operator:${RELEASE}/" bundle/manifests/quay-operator.clusterserviceversion.yaml
